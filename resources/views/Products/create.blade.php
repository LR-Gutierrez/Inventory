            ...
            <form class="space-y-4 md:space-y-6" method="post" action="{{ route('products.store') }}">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="item_quantity" id="item_quantity" placeholder="Enter existing quantity" class="integerNumbers bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('item_quantity') }}" maxlength="11">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="new_category" id="new_category" class="integerNumbers bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the product price" value="{{ old('price') }}" maxlength="11">
                    </div>
                    {{-- <div>
