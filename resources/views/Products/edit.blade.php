...
@section('content')
    ...
    <nav class="flex pb-3" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{ route('products.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Suppliers</a>
            </div>
        </li>
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" method="post" action="{{ route('products.update', ['id' => $product->id]) }}">
                @method('PUT')
                @if ($errors->any())
